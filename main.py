...
def parse_args():
    ...
    parser.add_argument('--data_mean', type=list, default=[12.821317571621165, -7.897515631964467, -4.923801939656684], help='data_mean(bgr) from data_mean.py')
    ...
    parser.add_argument('--batch_size', type=int, default=5, help='The size of batch size')
