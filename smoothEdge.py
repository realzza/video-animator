...
def parse_args():
    ...
    parser.add_argument('--img_size', type=list, default=[256,256], help='The size of image')
...
def make_edge_smooth(dataset_name, img_size) :
    ...
    for f in tqdm(file_list) :
        ...
        bgr_img = cv2.resize(bgr_img, (img_size[0], img_size[1]))
        pad_img = np.pad(bgr_img, ((2, 2), (2, 2), (0, 0)), mode='reflect')
        gray_img = cv2.resize(gray_img, (img_size[0], img_size[1]))
